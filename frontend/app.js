...
const INGREDIENT_CLASS_MAP = {
  ...
  "里脊肉": { class: "猪肉", category: "meat" },
  "猪里脊": { class: "猪肉", category: "meat" },
  "猪里脊肉": { class: "猪肉", category: "meat" },
  ...
  "牛里脊": { class: "牛肉", category: "meat" },
  "肥牛": { class: "牛肉", category: "meat" },
  "牛排": { class: "牛肉", category: "meat" },
  "牛腱": { class: "牛肉", category: "meat" },
  "牛腱子": { class: "牛肉", category: "meat" },
  // 羊肉类
...
const INGREDIENT_SYNONYM_GROUPS = [
  ...
  // —— 牛肉家族 ——
  ["牛肉", "牛腱子", "牛腱", "牛腩", "牛柳", "牛排", "肥牛", "肥牛卷", "牛肉片", "牛肉丝", "牛肉粒",
    "牛肋排", "牛里脊", "牛舌", "牛仔骨", "牛尾"],
  // —— 羊肉家族 ——
